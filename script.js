...
function initNavigation() {
    ...
    window.addEventListener('scroll', () => {
        ...
        const scrollThreshold = isDesktop ? navbarHeight : 100; // Desktop: match click event, Mobile: use 100px
        ...
        let isInAbout = false;
        if (aboutSection) {
            // Desktop: Check section title position (matches click event trigger)
            if (isDesktop) {
                const sectionTitle = aboutSection.querySelector('.section-title');
                const targetElement = sectionTitle || aboutSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    isInAbout = true;
                    current = 'about';
                }
            } else {
        ...
        // Find "Here's What I'm Doing" section within experience section
        ...
        if (experienceSection) {
            ...
            if (isDesktop) {
                ...
                const targetElement = sectionTitle || experienceSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    isInExperience = true;
                    current = 'experience';
        ...
        // Check "Here's What I'm Doing" section (within experience section)
        ...
        if (educationSection) {
            if (isDesktop) {
                const sectionTitle = educationSection.querySelector('.section-title');
                const targetElement = sectionTitle || educationSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    current = 'education';
                }
        ...
        if (skillsSection) {
            if (isDesktop) {
                ...
                const targetElement = sectionTitle || skillsSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    isInSkills = true;
                    current = 'skills';
        ...
        if (projectsSection) {
            if (isDesktop) {
                ...
                const targetElement = sectionTitle || projectsSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    current = 'projects';
                }
        ...
        if (portfolioSection) {
            if (isDesktop) {
                ...
                const targetElement = sectionTitle || portfolioSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    isInPortfolio = true;
                    current = 'portfolio';
        ...
        if (contactSection) {
            if (isDesktop) {
                ...
                const targetElement = sectionTitle || contactSection;
                const rect = targetElement.getBoundingClientRect();
                if (rect.top <= navbarHeight + 10 && rect.top >= navbarHeight - 50) {
                    isInContact = true;
                    current = 'contact';
        ...
        // Update desktop underline position on scroll
        if (window.innerWidth > 1024) {
            updateNavIndicator();
        }
    });

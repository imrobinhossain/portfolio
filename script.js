...
function scrollCertifications(direction) {
    ...
    // Apply the new position with smooth transition - same timing for both directions
    ...
    setTimeout(() => {
        ...
        if (direction === 'next' && currentScrollPosition >= totalCardsWidth) {
            ...
            // Reset to end seamlessly - optimized calculation
            track.style.transition = 'none';
    ...
    }, 600); // Match transition duration for both directions

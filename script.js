...
function animateCircularProgress(progressFill, targetPercentage) {
    ...
    function updateProgress(currentTime) {
        ...
        if (progress < 1) {
            ...
            progressFill.style.background = `conic-gradient(#ffffff ${currentPercentage * 3.6}deg, transparent ${currentPercentage * 3.6}deg)`;
            requestAnimationFrame(updateProgress);
        } else {
            // Set final value
            progressFill.style.background = `conic-gradient(#ffffff ${targetPercentage * 3.6}deg, transparent ${targetPercentage * 3.6}deg)`;
        }
    }
